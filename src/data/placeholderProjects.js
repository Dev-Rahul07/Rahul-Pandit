export const placeholderProjects = [
  {
    ...
    description: `This Expense Tracker App helps users keep track of their daily expenses and budgets.
It features add, edit, and delete options, along with data visualization charts for spending insights.
The backend is powered by Django REST API, and the frontend is built using React.js with a clean, responsive UI.`,
  ...
  },
  {
    ...
    description: `This is a web-based attendance system built using Python Django.
